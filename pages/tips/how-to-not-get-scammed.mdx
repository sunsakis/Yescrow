import SEO, {MDXLayout} from '../../components/SEO';
import Header from '../../components/header';

<SEO 
    title={"Yes Crow - How To Not Get Scammed - Using A Free Escrow"}
    content={"When transacting on the internet - use protection: the only way to trust a stranger online is to use an escrow."}
    canonical={"https://yescrow.io/tips/how-to-not-get-scammed"}
/>
<Header/>
# Learn How To Prevent Online Fraud And Scams With Free Escrow Payments.
<br/>
A beautiful article coming up very soon.
 {/* <div class="container max-w-4xl mx-auto justify-center">
                <span class="pl-10 pr-10 text-left">
                    <main>
                    <h1 class="text-4xl font-bold text-white text-center">An Ethereum Escrow Safeguarding Online Transactions and Preventing Scams</h1>
                    <br />
                    <p>
