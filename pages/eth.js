...
import ETHDeposit from '../components/ethDeposit.js';
...
export default function ETH() {
        ...
        "@graph": [
          {
            ...
            "potentialAction": {
              ...
              "description": "Escrow ETH"
            },
            "serviceType": "ETH Escrow",
            "logo": {
              "@type": "ImageObject",
  ...
  return (
    <div class="container max-w-2xl mx-auto justify-center">
      <Head>
        <title>Escrow ETH | Yescrow</title>
        <meta 
          name="description" 
      ...
      />
        ...
        <main>
        <div> 
          <h1 class="m-4 text-4xl text-center font-bold">Escrow Ether to establish online trust.</h1>
