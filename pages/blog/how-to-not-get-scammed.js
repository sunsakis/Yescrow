...
export default function Tips() {
    ...
    return (
      ...
      <Script
        ...
        <Header />
        <main>
            <h1 class="m-4 text-4xl text-center font-bold">How To Not Get Scammed Online (Hint: Use Yes Crow)</h1>
            <br/>
            <div>
            <Image layout="responsive" src="/internet_scammer.png" width="108" height="108" viewBox="0 0 108 108" xmlns="http://www.w3.org/2000/svg" alt="internet scammer generated by AI"></Image>
            </div>
            <br/>
            <p>
            ...
            <br/>
            <p>
            Now you can use MetaMask to sign transactions and <Link href="/usdt" class="text-matrix underline"> escrow USDT as well as Ethereum</Link>, and all the other tokens on the Ethereum blockchain!
            <br/><br/>
