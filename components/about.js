...
export default function About() {
    return (
        <div>
            <h1 className={styles.title}><code>yescrow:</code> crypto escrow services</h1><br />
            <br/>
        ...
        <p> With a smart contract escrow, the <u>costs are minimized</u> and the processes are automated, so you are the one to release the funds once satisfied. </p><br/> <p>Without a bank, a financial service is finally as simple and private as <b>you</b> want it to be.</p><br/>
        <h2 className={styles.title}>Blockchain escrow usecases:</h2><br /><br/>
	...
	<p>Using an audited crypto escrow service can provide peace of mind for both parties involved in <b>any</b> transaction, helping to <u>reduce the risk of fraud</u>. </p>
        ...
        <p>Escrow <Link href="/eth" className="hover:text-teal-500">Ether</Link>, <Link href="/usd" className="hover:text-teal-500">USDC</Link>, <Link href="/btc" className="hover:text-teal-500">Bitcoin</Link> and <Link href="/nft" className="hover:text-teal-500">NFTs</Link> in an automated, smart contract fashion.</p>
        </div>
    )
}